...
public:
	...
	inline ActorSequencer2D(ActorSequencer2D&& other) : ActorRenderBase2D(std::move(other)), m_Transformer(std::move(other.m_Transformer)) {}
	...
	inline ActorSequencer2D& operator=(ActorSequencer2D&& other)
	{
